...
export interface Notification {
  ...
  actionText?: string;
  viewType?: "farmer" | "advisor"; // Add viewType to distinguish notifications
}
...
export const NotificationProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // Initialize with separate notifications for farmer and advisor
  useEffect(() => {
    const isAdvisorView = window.location.pathname.includes("/advisor");
    
    // Farmer-specific notifications
    const farmerNotifications: Omit<Notification, "id" | "read">[] = [
      {
        type: "weather",
        title: "Frost Warning",
    ...
    const allNotifications = [...farmerNotifications, ...advisorNotifications].map(notif => ({
      ...notif,
